...
[bugs]: https://github.com/discite/personalis/issues/new?assignees=&labels=bug&template=bug_report.md&title=
[feature requests]: https://github.com/discite/personalis/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=
["Custom issue"]: https://github.com/discite/personalis/issues/new?assignees=&labels=&template=custom_issue.md&title=
...
See <https://github.com/discite/personalis/issues/labels> for details on individual labels.

### Categories

- Assorted

  Labels without prefix like [`breaking`](https://github.com/discite/personalis/labels/breaking),
  [`good first issue`](https://github.com/discite/personalis/labels/good%20first%20issue) or
  [`help wanted`](https://github.com/discite/personalis/labels/help%20wanted).
